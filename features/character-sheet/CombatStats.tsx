                ...
                <div className="flex items-baseline justify-between">
                    {isEditing ? (
                        <input 
                            ...
                            className="ghost-input w-full border-b border-white/20 text-3xl font-body font-light text-white focus:border-accent-rose text-left" 
                        />
                    ) : (
                ...
                <div className="flex items-baseline justify-between">
                     {isEditing ? (
                        <input 
                            ...
                            className="ghost-input w-full border-b border-white/20 text-3xl font-body font-light text-white focus:border-cyan-400 text-left" 
                        />
                    ) : (
                 ...
                 <div className="flex items-baseline justify-between">
                    {isEditing ? (
                        <input 
                            ...
                            className="ghost-input w-full border-b border-white/20 text-3xl font-body font-light text-white focus:border-gold-500 text-left" 
                        />
                    ) : (
