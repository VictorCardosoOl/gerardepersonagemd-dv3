  ...
  return (
    <div className="w-full max-w-[1400px] mx-auto px-4 md:px-8 py-10 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 relative z-10">
            ...
            <div className="md:col-span-12 glass-panel rounded-[2rem] p-8 relative overflow-hidden flex flex-wrap justify-between items-center gap-6 bg-void-900/60 shadow-glass border-white/5">
            ...
            <div className="md:col-span-12 lg:col-span-3 flex flex-col gap-6 h-full">
